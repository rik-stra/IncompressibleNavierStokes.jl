...
# load reference data
track_file = out_dir*"data_track_trackingnoise_mu_$(tracking_noise)_Re2000.0_tsim10.0.jld2"
...
for i in 1:n_replicas
    ...
    if hist_len == 0
        ...
        q_hist = ArrayType{T}(zeros(T,size(params.qois,1),hist_len)) #give first #histlen dQ values, the first dQ value should be at end of array
