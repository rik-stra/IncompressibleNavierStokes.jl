...
(; name, tracking_noise, n_replicas) = inputs[model_index]
...
# Save tracking data
jldsave("$outdir/data_track_trackingnoise_mu_$(tracking_noise)_Re$(Re)_tsim$(tsim).jld2"; data_track, params_track);